function Get-UmsConfigurationItem
{
    ...
    Param(
        ...
        [ValidateSet(
            ...
            "MediumTitlePrefix",
            "MediumTitleSuffix",
            "MusicalKeyCapitalizeFirstLetter",
    ...
    if ($ShortName)
    {
        ...
        {            
            ...
            "MusicalKeyCapitalizeFirstLetter"   { return (Get-UmsConfigurationItem -Type Rendering | Where-Object { $_.Id -eq "musical-key-capitalize-first-letter" }).Value }

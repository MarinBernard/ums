...
<xsl:stylesheet version="3.0"
	...
	=============================================================================
	!
	!	List template for umsb:labelVariants base lists
	!____________________________________________________________________________
	!
	!	This template converts a list of label variants to a localized XML
	!	document or simple string.
	!
	=============================================================================
	-->
	<xsl:template name="BLT_LabelVariants">
		<!--
		=============================================================================
		!	Template parameters
		=============================================================================
		...
		<xsl:variable name="_preferedVariant">
			<xsl:for-each select="umsb:labelVariant[@lang = $config.ums.variants.preferredLanguage]">
				<xsl:call-template name="BRT_LabelVariant">
		...
		<xsl:variable name="_fallbackVariant">
			<xsl:for-each select="umsb:labelVariant[@lang = $config.ums.variants.fallbackLanguage]">
				<xsl:call-template name="BRT_LabelVariant">
					<xsl:with-param name="OutputFormat" select="$OutputFormat"/>
				</xsl:call-template>
			</xsl:for-each>

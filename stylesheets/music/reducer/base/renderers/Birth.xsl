...
<xsl:stylesheet version="3.0"
	...
	=============================================================================
	!
	!	Rendering template for umsb:birth base elements
	!____________________________________________________________________________
	!
	!	This template converts a single umsb:birth element to a localized
	!	XML document or simple string.
	!
	=============================================================================
	-->
	<xsl:template name="BRT_Birth">
		<!--
		=============================================================================
		!	Template parameters
		=============================================================================
		...
		<xsl:variable name="_output">
			<xsl:choose>
				...
				<xsl:when test="lower-case($OutputFormat) = 'xml'">
					<xsl:element name="umsb:birthDate">
						<xsl:value-of select="$_eventInheritedElements/umsb:date"/>
					</xsl:element>
					<xsl:element name="umsb:birthPlace">

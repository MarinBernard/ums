...
<xsl:stylesheet version="3.0"
	...
	<xsl:template name="LT_NameVariants">
		<!--======================================================================
		 !	Template parameters
		 =========================================================================-->
		<!-- Labels -->
		...
		<xsl:call-template name="showDebugMessage">
			<xsl:with-param name="Template" select="'LT_NameVariants'"/>
		...
		<xsl:variable name="_preferedLanguageVariant">
			<xsl:for-each select="umsc:nameVariant[@lang = $config.variants.preferredLanguage]">
				<xsl:call-template name="RT_NameVariant">
		...
		<xsl:variable name="_fallbackLanguageVariant">
			<xsl:for-each select="umsc:nameVariant[@lang = $config.variants.fallbackLanguage]">
				<xsl:call-template name="RT_NameVariant">
					<xsl:with-param name="Label_Full" select="$Label_Full"/>
					<xsl:with-param name="Label_Sort" select="$Label_Sort"/>
					<xsl:with-param name="Label_Short" select="$Label_Short"/>
		...
		<xsl:variable name="_defaultVariant">
			<xsl:for-each select="umsc:nameVariant[@default = true()]">
				<xsl:call-template name="RT_NameVariant">
					<xsl:with-param name="Label_Full" select="$Label_Full"/>
					<xsl:with-param name="Label_Sort" select="$Label_Sort"/>
					<xsl:with-param name="Label_Short" select="$Label_Short"/>
		...
		<xsl:variable name="_originalVariant">
			<xsl:for-each select="umsc:nameVariant[@original = true()]">
				<xsl:call-template name="RT_NameVariant">
					<xsl:with-param name="Label_Full" select="$Label_Full"/>
					<xsl:with-param name="Label_Sort" select="$Label_Sort"/>
					<xsl:with-param name="Label_Short" select="$Label_Short"/>
